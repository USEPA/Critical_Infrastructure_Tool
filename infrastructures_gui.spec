...
added_files = [('default.csv', '.'),('Contaminated','Contaminated\\') ,('infrastructures_inputs.txt', '.'),('Sensitivity Images','Sensitivity Images\\'),('Sensitivity','Sensitivity\\'),('report_inputs.txt','.'), ('DefineScenario.xlsx','.'),  ("dist\\sensitivity_GUI", "."), ('final_pdf.py','.'), ('Battelle.EPA.WideAreaDecon.Launcher.exe','.'),('Battelle.Native.External.Rmath.dll','.'),('Battelle.RiskAssessment.Common.Statistics.Native.Interface.dll','.'), ("executingDirectoryPath", "executingDirectoryPath\\"),("azure", "azure\\"),("Azure-ttk-theme-main", "Azure-ttk-theme-main\\"),("azure.tcl","."),("palettable","palettable\\"),("Affected","Affected\\"),("Contaminated","Contaminated\\"),("Overall","Overall\\"),("JobRequest.json","."),("SIRMResults.json",".")("newJobRequest.json","."),("Results","Results\\"),]
