    ...
    class StartPage(tk.Frame):
        ...
        def __init__(self, parent, controller):
            ...
            def run(optimize):
                ...
                # data["n0"] = var5.get()
                # data["p0"] = var6.get()
                # data["repair_factors"] = var7.get()
                # data["nLoss"] = var8.get()
                # data["tLoss"] = var9.get()
                # data["timeSpan"] = var12.get()
                # data["nRun"] = var10.get()
                # data["paramTypes"] = var13.get()
                # data["paramIndexes"] = var14.get()
                ...
                # data["name"] = var17.get()
                # data["remediationFactor"] = var18.get()
                # data["contamination"] = var19.get()
                # data["backups"] = var21.get()
                # data["backupPercent"] = var22.get()
                # data["daysBackup"] = var23.get()
                # data["depBackup"] = var24.get()
                ...
                data["negatives"] = var25.get()
                fileLoc = dirpath + "//" + "infrastructure_inputs.json"
